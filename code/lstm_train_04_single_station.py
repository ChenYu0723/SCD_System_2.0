...
# 每个station单独训练model，epoch后测试剩余样本的mae，记录所有站点mae
...
def main(STATION_ID):
    ...
    torch.save(lstm, 'model/net_lstm_%s.pkl' % STATION_ID)

    return mape_sta, mae_sta
